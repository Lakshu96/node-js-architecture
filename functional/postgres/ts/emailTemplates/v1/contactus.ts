...
const contactUsTemplate = async (data:ContactUsData): Promise<string> => {
    return `
            ...
            <p style="line-height: 22px; color: #555659; text-align: left; padding: 0 20px;margin: 0;"><b>PhoneNo:</b> ${data.phoneNo}</p>
                ...
                <tr>
                    <td>
                        ...
                        If you encounter any other difficulties, please contact <a style="color: #ff5c5d; text-decoration: underline;" href="mailto:devteam@itechnolabs.biz">devteam@itechnolabs.biz</a>.</p>
                    </td>
                </tr>
                <tr>
                    <td>
                        <p style="line-height: 26px; color: #555659; text-align: left; padding: 0 20px;">
                        Regards, <br>Itechnolabs</p>
                    </td>
                </tr>
                </table>
